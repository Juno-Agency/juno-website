...
> = {
  NEW: { label: 'Nouveau', color: '#8cc63f' },
  CONTACTED: { label: 'Contacté', color: '#3b9ed6' },
  QUOTED: { label: 'Devis envoyé', color: '#d6a93b' },
  WON: { label: 'Gagné', color: '#52d28a' },
  LOST: { label: 'Perdu', color: '#c0455e' },
};
