...
export const TRANSLATIONS: Record<Exclude<Lang, 'fr'>, Record<string, string>> = {
  en: {
    ...
    'Une sélection de sites qu’on a dessinés, codés et livrés. Chaque projet, pensé sur-mesure.':
      'A selection of sites we designed, built and shipped. Every one made to measure.',
    'Chargement…': 'Loading…',
    'Impossible de charger les réalisations pour le moment.': 'We can’t load the portfolio right now.',
    'Nos premières réalisations arrivent très bientôt.': 'Our first projects are coming very soon.',
    ...
    'On conçoit chaque site depuis une page blanche, pour des commerces et des indépendants. Pas de template, pas de thème recyclé, pas de raccourci.':
      'We design every site from a blank page, for shops and independents. No templates, no recycled themes, no shortcuts.',
    Tarifs: 'Pricing',
    Contact: 'Contact',
    Blog: 'Blog',
    FAQ: 'FAQ',
  ...
  de: {
    ...
    Catalogue: 'Katalog',
    Réalisations: 'Portfolio',
    'Nos réalisations': 'Unsere Arbeiten',
    'Une sélection de sites qu’on a dessinés, codés et livrés. Chaque projet, pensé sur-mesure.':
      'Eine Auswahl an Websites, die wir entworfen, entwickelt und geliefert haben. Jedes Projekt maßgeschneidert.',
    'Chargement…': 'Wird geladen…',
    'Impossible de charger les réalisations pour le moment.': 'Die Referenzen können gerade nicht geladen werden.',
    'Nos premières réalisations arrivent très bientôt.': 'Unsere ersten Projekte kommen sehr bald.',
    'Glissez pour explorer': 'Ziehen zum Entdecken',
    'Voir le projet': 'Projekt ansehen',
    'Voir le site': 'Website besuchen',
    Fermer: 'Schließen',
    'Précédent': 'Zurück',
    'Autres projets': 'Weitere Projekte',
    'On conçoit chaque site depuis une page blanche, pour des commerces et des indépendants. Pas de template, pas de thème recyclé, pas de raccourci.':
      'Wir gestalten jede Website vom weißen Blatt aus, für Geschäfte und Selbstständige. Keine Templates, keine recycelten Themes, keine Abkürzungen.',
    Tarifs: 'Preise',
    Contact: 'Kontakt',
    Blog: 'Blog',
    FAQ: 'FAQ',
